...
namespace NCL::Rendering {
	...
	public:
		OGLShader(const std::string& vertex, const std::string& fragment, const std::string& compute = "", const std::string & geometry = "", const std::string & domain = "", const std::string & hull = "");
		~OGLShader();
